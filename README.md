...
<img src="/img/company_structure.png" alt="Структура компании Стандарт" width="100%"/>
...
Ещё за этот год нужно реализовать подачу кредитной заявки из интернет-банка. При этом клиент сразу должен видеть, сможет ли потенциально получить кредит.
