...
3. **Подготовьте RoadMap в draw.io.**  
   Это схема последовательности выполнения задач для MVP на горизонте 6 месяцев с учётом изменений в новом кейсе и целевого решения на горизонте года. Можете взять за основу [такой формат](RoadMap_bank_Standart.drawio):

<img src="/img/Task4/Template_RoadMap_bank_Standart.png" alt="Пример Draw.io из задания" width="100%"/>
